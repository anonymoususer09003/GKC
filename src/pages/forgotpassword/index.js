            ...
            <div style={{ maxWidth: '380px', width: '100%' }}>
              ...
              <div>
                ...
                <div>
                  ...
                  <input type="text" className="w-100 p-2 rounded outline-0 border border_gray text_gray  mb-3" placeholder='Enter Confirmation Code'/>
                  <p className="text-secondary fw-bold py-2 text-center">Check Email for Confirmation Code</p>
