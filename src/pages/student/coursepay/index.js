      ...
      {success ? (
        ...
        >
          ...
          >
            ...
            >
              A review request has been sent to {fullParentName}. Class will be
              booked upon approval and payment.
            </p>
              ...
              <div>
                ...
                <div className="py-2">
                  ...
                  <div className="d-flex gap-3 py-1">
                    ...
                    <p className="p-0 m-0 fw-bold">
                      {durationInHours ?? 'Calculating..'} Hrs
                    </p>
                  </div>
                  <div className="d-flex gap-3 py-1">
                    ...
                    <p className="p-0 m-0 fw-bold">
                      {formatNumberWithTwoDecimals(
                        instructorData?.hourlyRate *
                          durationInHours *
                          (taxesFeesInfo?.feePercentage / 100) +
                          taxesFeesInfo?.additionalFeeAmount
                      ) ?? 'Calculating..'}{' '}
                      USD
                    </p>
                  </div>
                  <div className="d-flex gap-3 py-1">
                    ...
                    <p className="p-0 m-0 fw-bold">
                      {formatNumberWithTwoDecimals(
                        instructorData?.hourlyRate * durationInHours +
                          instructorData?.hourlyRate *
                            durationInHours *
                            (taxesFeesInfo?.feePercentage / 100) +
                          taxesFeesInfo?.additionalFeeAmount
                ...
                <div className="py-2">
                  <select
                    ...
                    onChange={() => {
                      setSavedCCSelected(!savedCCSelected);
                    }}
                  >
                    <option>
                      {hasSavedCC ? 'Select' : 'No saved CC info'}
                    </option>
                    {hasSavedCC && (
                      <option>
                        ...{loggedUserCCinfo?.last4Digits ?? 'Error'}
                      </option>
                    )}
                  </select>
                </div>
                      ...
                      if (whoPaysId !== 'Select') {
                        ...
                        if (savedCCSelected) {
                          ...
                          if (isCardValid) {
                            ...
                            setErr(
                              'Unfortunately your signed data mismatched, please try again or contact us.'
                            );
                          }
                        }
                      }
