  ...
  return (
    <>
      ...
      <main className="container-fluid">
        <div className="d-flex justify-content-between gap-5  p-5 " style={{height: "90vh"}}>
          <div className="w-50 pt-5">
            <Calendar onChange={onChange} value={value} />
          </div>
          <div className="w-50">
            <h3 className="text-center">Schedule</h3>
            <div className=" shadow p-5 bg-white rounded " style={{minHeight: "400px"}}>
              <div className="d-flex align-items-center py-3">
                <h5 className="p-0 m-0 flex-fill fw-bold flex-fill">John Doe</h5>
                <h5 className="p-0 m-0 flex-fill fw-bold flex-fill">11:00AM</h5>
                <BsFillChatFill className="p-0 m-0 flex-fill h2 flex-fill"/>
          
                <GoDeviceCameraVideo className="p-0 m-0 flex-fill h2 flex-fill"       data-bs-toggle="modal"
