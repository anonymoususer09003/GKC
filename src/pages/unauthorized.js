       ...
       <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div>
            ...
            <div class="flex items-center mt-6 gap-x-3">
                ...
                : 
                <button class="bg-primary w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600" onClick={()=> router.push('/auth/signin')}>
                    Login
                </button>
                }
            </div>
